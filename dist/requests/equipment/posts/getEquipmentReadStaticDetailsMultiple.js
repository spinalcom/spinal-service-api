...
exports.getEquipmentReadStaticDetailsMultiple = getEquipmentReadStaticDetailsMultiple;
const lodash_chunk_1 = __importDefault(require("lodash.chunk"));
const spinalAPI_1 = require("../../../spinalAPI"); // chemin relatif à src/requests/building
function getEquipmentReadStaticDetailsMultiple(buildingId_1, dynamicIds_1) {
