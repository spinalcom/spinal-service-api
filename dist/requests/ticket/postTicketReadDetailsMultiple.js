...
exports.getTicketDetailsMultiple = getTicketDetailsMultiple;
const spinalAPI_1 = require("../../spinalAPI"); // chemin relatif à src/requests/building
function getTicketDetailsMultiple(ticketIds) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let result = yield spinalAPI.post(url, ticketIds);
        return result.data;
    });
}
//# sourceMappingURL=postTicketReadDetailsMultiple.js.map