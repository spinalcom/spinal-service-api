...
exports.deleteCategoryAttribut = deleteCategoryAttribut;
const spinalAPI_1 = require("../../spinalAPI"); // chemin relatif à src/requests/building
function deleteCategoryAttribut(buildingId, referenceId, cateId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield spinalAPI.delete(url);
        console.log(res);
        return res;
    });
}
//# sourceMappingURL=deleteCategoryAttribut.js.map