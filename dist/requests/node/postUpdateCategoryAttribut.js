...
exports.postUpdateCategoryAttribut = postUpdateCategoryAttribut;
const spinalAPI_1 = require("../../spinalAPI"); // chemin relatif à src/requests/building
function postUpdateCategoryAttribut(buildingId, referenceId, cateId, item) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield spinalAPI.put(url, item);
        console.log(res);
        return res;
    });
}
//# sourceMappingURL=postUpdateCategoryAttribut.js.map