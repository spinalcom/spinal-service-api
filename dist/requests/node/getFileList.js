...
exports.getNodeFileList = getNodeFileList;
const spinalAPI_1 = require("../../spinalAPI");
function getNodeFileList(nodeId) {
    return __awaiter(this, void 0, void 0, function* () {
        const platformId = localStorage.getItem("idBuilding") || "";
        const spinalAPI = spinalAPI_1.SpinalAPI.getInstance();
        const url = spinalAPI.createUrlWithPlatformId(platformId, `api/v1/node/${nodeId}/file_list`);
